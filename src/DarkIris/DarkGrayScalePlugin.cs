...
namespace DarkIris
{
    ...
    public class DarkGrayScalePlugin : PropertyBasedEffect
    {
        public static string StaticName { get { return "Patch gray-scale normal"; } }

        public static Image StaticIcon { get { return DarkIris.Properties.Resources.IrisIcon; } }

        public DarkGrayScalePlugin()
            : base(DarkGrayScalePlugin.StaticName, DarkGrayScalePlugin.StaticIcon, "DarkIris Tools", EffectFlags.ForceAliasedSelectionQuality)
        {
        }
        ...
        private unsafe void Render(Surface dst, Surface src, Rectangle rect)
        {
            ...
            for (int i = rect.Top; i < rect.Bottom; i++)
            {
                ...
                for (int j = rect.Left; j < rect.Right; j++)
                {
                    ...
                    colorBgra = ColorBgra.FromBgra(255, colorBgra.G, colorBgra.A, 255);
